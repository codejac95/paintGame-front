...
function App() {
  ...
  return (
    <>
      ...
      <div>
        {/* Visa GameComponent om användaren är inloggad och har gått med i spelet */}
        {loginStatus && joinedGame && (
          <GameComponent loginStatus={loginStatus} assignedSquare={assignedSquare} playerName={'loggedInUser'} />
        )}
      </div>
    </>
    )
